# r2/ — empty, and it stays empty

**Nestle 1889 contains no R2 material.** Verified on the plate, not inferred:

- The Table of Contents lists no exercise section.
...
marked as ours). Do not size Phase 1 as though Nestle supplies R2.
